          ...
          <div className="max-w-4xl mx-auto space-y-8">
            <div className="text-center space-y-4">
              <h1 className="text-3xl md:text-4xl font-bold text-slate-900">
                ⚖️ Obesitas atau Berat Badan Berlebih
              </h1>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-xl overflow-hidden shadow-lg border border-gray-200">
                <div className="bg-gradient-to-r from-orange-500 to-orange-600 px-4 md:px-6 py-4">
                  <h4 className="text-base md:text-lg font-bold text-white">⚖️ Cara Mengukur Berat Badan & Lingkar Perut</h4>
                </div>
                <div className="p-0 sm:p-2 md:p-4">
                  <div className="aspect-video rounded-none sm:rounded-lg overflow-hidden bg-gray-100">
                    <iframe
                      width="100%"
                      height="100%"
            ...
            <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl p-6 text-white">
              <p className="text-lg leading-relaxed">
                ...
                <strong>Menjaga berat badan ideal membantu tubuh menggunakan insulin dengan lebih efektif.</strong>
              </p>
            </div>
          </div>
        </SectionContainer>
