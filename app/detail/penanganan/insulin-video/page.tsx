...
export default function InsulinVideoPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <main className="container mx-auto px-2 sm:px-4 py-6 md:py-12">
        {/* Back Button */}
        <Link
          href="/#penanganan"
          className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 font-medium mb-4 md:mb-6 px-2 transition-colors group"
        >
        ...
        {/* Header */}
        <div className="max-w-5xl mx-auto space-y-4 md:space-y-6 mb-6 md:mb-10 px-2">
          <div className="text-center space-y-3 md:space-y-4">
            <div className="inline-block p-3 md:p-4 bg-blue-100 rounded-full mb-2">
              <span className="text-4xl md:text-5xl">💉</span>
            </div>
            <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold text-slate-900 px-2">
              Video Panduan Penggunaan Insulin
            </h1>
            <p className="text-base md:text-lg text-slate-600 leading-relaxed max-w-3xl mx-auto px-2">
        ...
        <div className="max-w-5xl mx-auto space-y-6 md:space-y-8">
          ...
          <div className="bg-white rounded-xl md:rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
            <div className="bg-gradient-to-r from-blue-500 to-blue-600 px-4 md:px-6 py-4 md:py-5">
          ...
          <div className="bg-white rounded-xl md:rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
            <div className="bg-gradient-to-r from-indigo-500 to-indigo-600 px-4 md:px-6 py-4 md:py-5">
              <div className="flex items-center gap-2 md:gap-3">
                <span className="text-2xl md:text-3xl">💉</span>
                <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-white">
            ...
            <div className="p-2 sm:p-3 md:p-6">
              ...
              <div className="mt-3 md:mt-4 p-3 md:p-4 bg-indigo-50 rounded-lg">
                <p className="text-xs md:text-sm text-slate-700 leading-relaxed">
        ...
        {/* Info Box */}
        <div className="max-w-5xl mx-auto mt-6 md:mt-10 px-2">
          <div className="bg-amber-50 border-2 border-amber-300 rounded-xl p-4 md:p-6">
            <div className="flex items-start gap-3 md:gap-4">
              ...
              <div className="space-y-2">
                <h3 className="font-bold text-slate-900 text-base md:text-lg">Perhatian Penting</h3>
                <ul className="space-y-1.5 md:space-y-2 text-slate-700 text-sm md:text-base">
